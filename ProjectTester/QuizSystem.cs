                ...
                switch (adminChoice)
                {
                    case "1":
                        ...
                        do
                        {
                            ...
                            switch (userChoice) //validate inputs
                            {
                        ...
                        do
                        {
                            ...
                            switch (questionChoice)
                            {
                                ...
                                case "2":
                                    ...
                                    List<string> qOptions = optionsInput.Split(',').Select(o => o.Trim()).ToList(); //ambigous
                                ...
                                case "3":
                                    ...
                                    Console.Clear();
                                    foreach (Question ques in quizzes[quizId3 - 1].QuizQuestions)
                                    {
